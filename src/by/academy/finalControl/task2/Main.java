...
public class Main {
    ...
    public static void main(String[] args) {
        Airline airline = new Airline("Aviakompaniya");
            ...
            airline.addPlane(new Airliner(811.0, "Пассажирский", 11230.5, 18600.0,333.5,"AER950FT", "Boeing737", 180));
            airline.addPlane(new Airliner(936.5, "Пассажирский", 11345.0, 17450.0,320.5,"AER951FT", "Boeing747", 232));
            ...
            System.out.println(Arrays.toString(airline.sortByRange(airline.getPlanesList()).toArray()));
            System.out.println("Общая грузподъемность самолетов: " + airline.getTotalCapacity() + "кг.");
            airline.findByFuel(300.0, 333.6);
